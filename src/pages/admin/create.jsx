    ...
    <>
      ...
      <PrivateRoute>
        <div className="mx-auto flex max-w-[1290px]">
          <Header />
          {redirectURL != '' ? (
            <main className="mb-2 ml-8 mt-10  flex h-screen w-[82%] items-center ">
              <Confetti
                width={width}
                height={height}
                tweenDuration={6000}
              ...
              <div className="mx-auto my-auto text-center">
                <h1 className="text-center text-3xl font-bold text-gray-800">
                  Successfully created a new survey!!🎉
                </h1>
                <div className="mt-8 min-w-0 rounded-xl bg-indigo-500 p-4 text-white">
                  <h1 className="text-center text-3xl font-bold ">{title}</h1>
                  <div className="my-4 flex justify-center">
                    <QRCode value={redirectURL} />
                  </div>
                  <p className="font-semibold">Share this QR to your friends!</p>
                  <p className="font-semibold">{redirectURL}</p>
                </div>
              </div>
            </main>
          ) : (
